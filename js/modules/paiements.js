...
// Porté depuis Clubly : l'ancien formulaire "+ Ajouter un paiement" inline (add-form) devient
// une fiche qui glisse depuis le bas — voir window.__showAddPaiement, câblé sur
// #toggle-add-paiement, fermée via data-close-sheet="showAddPaiement".
