...
function getFoodtrucksMenusFolder() {
  ...
  const folder = DriveApp.createFolder("ASHS - Menus foodtrucks");
...
// partagée en lecture pour tous ceux qui ont le lien (comme l'Espace salariés, voir Salaries.gs),
// et affichée via un lien direct https://lh3.googleusercontent.com/... (pas un iframe Drive).
